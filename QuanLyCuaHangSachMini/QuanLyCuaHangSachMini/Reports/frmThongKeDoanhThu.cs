...
namespace QuanLyCuaHangSachMini.GUI
{
    public partial class frmThongKeDoanhThu : Form
    {
        ...
        private Dictionary<int, decimal> LayTongTienHoanTraTheoHoaDon()
        {
            return context.PhieuHoanTra
                .Select(r => new
                {
                    r.HoaDonID,
                    TongTien = r.PhieuHoanTra_ChiTiet.Sum(ct => (decimal?)ct.SoLuongTra * ct.DonGiaHoanTra) ?? 0
                })
                .AsEnumerable()
        ...
        {
            Dictionary<int, decimal> tongHoanTraTheoHoaDon = LayTongTienHoanTraTheoHoaDon();
            ...
            return context.HoaDon
                ...
                .Select(r => new
                {
                    ...
                    r.NgayLap,
                    r.GhiChuHoaDon,
                    TongTienHoaDon = Math.Max(0m, r.TongTienHoaDon - (tongHoanTraTheoHoaDon.ContainsKey(r.ID) ? tongHoanTraTheoHoaDon[r.ID] : 0m))
                })
                .OrderBy(r => r.NgayLap)
                .ToList<dynamic>();
        }
        ...
        private void NapReport(List<dynamic> danhSachHoaDon, string moTa)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Không tìm th?y file report: rptThongKeDoanhThu.rdlc", "L?i",
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(loi, "L?i report", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void frmThongKeDoanhThu_Load(object sender, EventArgs e)
        {
            ...
            NapReport(danhSachHoaDon, "(T?t c? hóa don)");
        }
        ...
        private void btnLocKetQua_Click(object sender, EventArgs e)
        {
            ...
            if (tuNgay > denNgay)
            {
                MessageBox.Show("T? ngày không du?c l?n hon d?n ngày.", "Thông báo",
            ...
            string moTa = "T? ngày " + dtpTuNgay.Text + " - Ð?n ngày " + dtpDenNgay.Text;
